...
public class ChinhSachGiaController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<ChinhSachGiaResponse>> getById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<ChinhSachGiaResponse>> update(@PathVariable UUID id, @Valid @RequestBody ChinhSachGiaRequest request) {
