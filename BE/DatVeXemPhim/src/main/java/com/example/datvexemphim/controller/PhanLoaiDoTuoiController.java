...
public class PhanLoaiDoTuoiController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<PhanLoaiDoTuoiResponse>> getById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PhanLoaiDoTuoiResponse>> update(@PathVariable UUID id, @Valid @RequestBody PhanLoaiDoTuoiRequest request) {
