...
public class GheNgoiController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<GheNgoiResponse>> getById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<GheNgoiResponse>> update(@PathVariable UUID id, @Valid @RequestBody GheNgoiRequest request) {
