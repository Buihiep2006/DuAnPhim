...
public class QuenMatKhauController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<QuenMatKhauResponse>> getById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<QuenMatKhauResponse>> update(@PathVariable UUID id, @Valid @RequestBody QuenMatKhauRequest request) {
